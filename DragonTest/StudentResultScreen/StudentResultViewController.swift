...
final class StudentResultViewController: UIViewController, StudentResultViewProtocol {
    ...
    override func viewDidLayoutSubviews() {
        ...
        // подгоним header под ширину/контент
    ...
    private func setupNavigation() {
        ...
        navigationItem.title = nil   // убираем системный заголовок
        title = nil
    }
    ...
    private func makeHeaderView() -> UIView {
        ...
        // контейнер для корректной высоты tableHeaderView
        ...
        // первичное наполнение значениями
        recomputeSummary()
    ...
    private func recomputeSummary() {
        ...
        let maxScore = rows * 10 // предполагаем шкалу 0..10 на вопрос
    ...
    func setTitle(_ text: String) {
        // прячем системный заголовок, кладём «имя теста» в белую плашку
