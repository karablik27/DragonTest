...
final class DragonSelectViewController: UIViewController, DragonSelectViewProtocol {
    ...
    func openTest(_ test: DragonTest) {
        ...
        let vc = DragonTestViewController(test: test, colors: test.dragon.gradientColors) { [weak self] completed in
    ...
    private func gradientForItem(_ item: CarouselItem) -> [CGColor] {
        ...
        case .test(let test): return test.dragon.gradientColors
        }
    }
